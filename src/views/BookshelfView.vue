        ...
        <div v-else-if="selectedBookshelf">
          <div
            ...
            <button @click="toggleDropdown"
              class="relative flex items-center justify-center mr-2 w-auto text-[#3a281d] gap-2 bg-[#C67B2F] drop-shadow-3xl py-2 px-4 rounded-xl text-3xl font-extrabold hover:bg-[#825221] transition w-[250px] cursor-pointer">
