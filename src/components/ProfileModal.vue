<template>
  <div v-on-click-outside="() => emits('close')"
    ...
    <ul class="py-1 text-sm text-gray-700">
      ...
      <li>
        <button @click="showLogoutModal = true;" class="w-full text-red-600 text-left px-4 py-2 hover:bg-gray-100">
    ...
    <div v-if="showLogoutModal"
      class="fixed inset-0 bg-black/[var(--bg-opacity)] [--bg-opacity:50%] flex items-center justify-center bg-black bg-opacity-50 z-50"
