<template>
    <div v-if="isOpen" class="fixed inset-0 bg-black/[var(--bg-opacity)] [--bg-opacity:50%] flex items-center justify-center">
      <div class="bg-white relative rounded-2xl p-6 w-full max-w-md shadow-xl">
        <button class="absolute top-0 right-0 text-xl font-bold px-4 py-3 rounded-tr-lg hover:bg-gray-300" @click="emit('close')">X</button>
